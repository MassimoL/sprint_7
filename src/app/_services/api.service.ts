...
import { FetchAllStarshipsResponse, Starship, Pilot, Film } from '@app/components/starships/interfaces/starships.interfaces';
...
export class ApiService {
  ...
  getAllStarships(page: number): Observable<Starship[]> {
    ...
    return this.http.get<FetchAllStarshipsResponse>(url)
      .pipe(
        map(this.transformStarshipsResult)
      )
  }

  private transformStarshipsResult(resp: FetchAllStarshipsResponse) {
  ...
  getStarshipDetailsById(starshipId: string): Observable<any> {
